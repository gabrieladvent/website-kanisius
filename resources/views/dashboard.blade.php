        ...
        <ul class="logout">
            ...
            <div class="col" style="margin-left: 5%; margin-top:5.6%">
                <div class="row mt-3 px-3 ">
                    ...
                    <div class="row d-flex justify-content-center border-2 border-top border-primary mt-3 container-fluid shadow-6-strong" style="border-radius: 20px">
                    ...
                    <div class="row d-flex justify-content-center  border-top border-primary border-2 mt-3 container-fluid shadow-6-strong" style="border-radius: 20px">
                        <div class="col">
                            <table class="table table-borderless mt-3 w-100  " style="background-color: #F5F4F4;">
                                <thead class="">
