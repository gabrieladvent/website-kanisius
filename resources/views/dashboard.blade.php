        ...
        <div class="row">
            <div class="col-1 ">
                <header>
                    <!-- Sidebar -->
                    <nav id="sidebarMenu "
                        class="collapse d-lg-block sidebar collapse bg-white container-fluid shadow-6-strong ">
                        <div class="position-sticky mx-2">
                            <div class="list-group list-group-flush mx-3 mt-4 text-center">
                                ...
                                <a href="#" class="list-group-item-action py-2 ripple ">
                                    <i class="fas fa-solid fa-database fa-lg me-3"></i>
                                </a>
                                <a href="#" class="list-group-item-action py-2 ripple"><i
                                        class="fas fa-solid fa-users fa-lg me-3"></i></a>
                                <a href="#" class="list-group-item-action py-2 ripple"><i
                                        class="fas fa-solid fa-bell fa-lg me-3"></i></a>
                                <a href="#" class=" mb-14  list-group-item-action py-2 ripple">
                                    <i class="fas fa-solid fa-book fa-lg me-3"></i>
                                </a>
                                <a href="#" class="list-group-item-action py-2 ripple"></a>
                                <a href="#" class="list-group-item-action py-2 ripple"><i class=""></i></a>
                                <a href="#" class="list-group-item-action py-2 ripple"><i class=""></i></a>
                                <a href="#" class="list-group-item-action py-2 ripple"><i class=""></i><a>
                                    <a href="#" class="list-group-item-action py-2 ripple"><i class=""></i><a></a>
                                        <a href="#" class="mt-5 list-group-item-action py-2 ripple"><i
                                                class="fas fa-solid fa-user fa-lg me-3"></i></a>
                                        <a href="#" class="list-group-item-action py-2 ripple"><i
                                                class="fas fa-solid fa-gear fa-lg me-3"></i></a>
            ...
            <div class="col">
                <div class="row mt-3 px-3 ">
                    <div class="col-3 ms-3">
                        <img src="../../public/image/logo baru.png" class="w-50 " alt="">
                    </div>
                    <div class="col-5 mt-5">
                        <img src="./img/alamat.png" class="w-75" alt="">
                    </div>
                    <div class="col-3 ms-5">
                        <img src="/img/IHS_Logo.png" class="w-75" alt="">
                    </div>

                    <!-- Message->
                        
                    <div class="row mt-5   container-fluid shadow-6-strong border border-dark py-4" style="width: 1200px;">
                        <div class="row border-bottom border-dark">
                            <div class="col-2 ">
                                <p>Message</p>
                            </div>
                            <div class="col-5 ">
                                <p>SD Kanisius Sanken mengirimkan file</p>
                            </div>
                            <div class="col-1 ">
                                <a href="" class="text-primary">Lihat</a>
                            </div>
                            <div class="col-2 ">
                                <a href="" class="text-primary">Download dan Upload</a>
                            </div>
                        </div>
