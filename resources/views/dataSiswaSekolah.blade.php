...
<div class="">
    ...
    <div class="data-siswa py-5 " style="background: #f1f1f1; margin-top: 6%;">
        <div class=" table-data" style="margin-left: 1%; margin-right:1%;">
            <p class="fs-3 fw-bold text-wrap text-center bg-light col-12" >Data Siswa-Siswi <strong class="datasiswadas">{{ $user->namasekolah}}</strong></p>
