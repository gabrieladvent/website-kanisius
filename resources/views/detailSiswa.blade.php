                        ...
                        <div class="card-body">
                            <div class="d-flex flex-column align-items-center text-center">
                                ...
                                <div class="mt-3">
                                    ...
                                    <p class="text-muted font-size-sm mb-1">NIS: {{ $item->NIS }}</p>
                                    <p class="text-muted font-size-sm mb-1">Tempat Tanggal Lahir:
                                        {{ $item->kota_lahir . ', ' . $item->tanggal_lahir }}
                                    </p>
                    ...
                    <div class="card mt-3">
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                ...
                                <span class="text-secondary">{{ $item->status ? $item->status : '-' }} </span>
                            </li>
                            <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                <h6 class="mb-0">Keterangan</h6>
                                <span class="text-secondary">{{ $item->keterangan ? $item->keterangan : '-' }} </span>
                            </li>
                            <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                <h6 class="mb-0">Keterangan 1</h6>
                                <span class="text-secondary">{{ $item->keterangan_satu ? $item->keterangan_satu : '-' }} </span>
                            </li>
                            <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                <h6 class="mb-0">Keterangan 2</h6>
                                <span class="text-secondary">{{ $item->keterangan_dua ? $item->keterangan_dua : '-' }} </span>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="col-md-4 mt-5">
                    <div class="card mb-3">
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col">
                                    <h6 class="mb-0">Nomor Virtual</h6>
                                </div>
                                <div class="col-sm-12 text-secondary">
                                    {{ $item->no_virtual ? $item->no_virtual : '-' }}
                                </div>
                            </div>
                            <hr>
                            <div class="row">
                                <div class="col">
                                    <h6 class="mb-0">Nomor Bank</h6>
                                </div>
                                <div class="col-sm-12 text-secondary">
                                    {{ $item->no_bank ? $item->no_bank : '-' }}
                                </div>
                            </div>
                            <hr>
                            <div class="row">
                                <div class="col">
                                    <h6 class="mb-0">Nomor Cabang</h6>
                                </div>
                                <div class="col-sm-12 text-secondary">
                                    {{ $item->no_cabang ? $item->no_cabang : '-' }}
                                </div>
                            </div>
                            <hr>
                            <div class="row">
                                ...
                                <div class="col-sm-12 text-secondary">
                                    {{ $item->tanggal_masuk ? $item->tanggal_masuk : '-' }}
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card mb-3">
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12 text-secondary">
                                    {{ $item->nama_orang_tua ? $item->nama_orang_tua : '-' }}
                                </div>
                            </div>
                            <hr>
                            <div class="row">
                                <div class="col">
                                    <h6 class="mb-0">Email Orang Tua</h6>
                                </div>
                                <div class="col-sm-12 text-secondary">
                                    {{ $item->email_orang_tua ? $item->email_orang_tua : '-' }}
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card mt-3">
                        <ul class="list-group list-group-flush">
                            ...
                            <li class="list-group-item justify-content-between align-items-center flex-wrap">
                                <div class="row">
                                    ...
                                    <div class="col">
                                        ...
                                        <span
                                            class="text-secondary">{{ $item->Rekening_atas_nama ? $item->Rekening_atas_nama : '-' }}
                                        </span>
                                    </div>
                                </div>
                            </li>
                            <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                ...
                                <span
                                    class="text-secondary">{{ $item->Nomor_Rekening_Bank ? $item->Nomor_Rekening_Bank : '-' }}
                                </span>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="card mb-3">
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12 text-secondary">
                                    <div class="row">
                                        <div class="col">{{ $item->No_Seri_Ijazah ? $item->No_Seri_Ijazah : '-' }}
                                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12 text-secondary">
                                    <div class="row">
                                        ...
                                        <div class="col">{{ $item->Alasan_Layak_PIP ? $item->Alasan_Layak_PIP : '-' }}
                                        </div>
                                    </div>
                                </div>
                            </div>
