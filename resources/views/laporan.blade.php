@php
    ...
    // setelah reload hapus semua nilai yang ada di filter
@endphp
...
<div class="data-siswa py-5 " style="background: #244076;">
    <div class=" table-data" style="margin-left: 1%; margin-right:1%;">
        <div class="card">
            ...
            <div class="col-md-12" style="background: #D9D9D9;">
                ...
                <form action="{{ route('laporan-hasil') }}" method="post" style="margin-left: 18vw;" id="formContainer">
                    @csrf 
                    <input type="hidden" name="title" value="{{$laporanType}}">
    ...
    @if (!empty(count($data_siswa)))
        ...
        {{-- <div class="data-siswa py-3"> --}}
                            ...
                            <div class="data-siswa py-3">
                                ...
                                <div class="text-center mt-2">
                                    ...
                                    <script>
                                        ...
                                        //thead += "<th>Rata-rata Penghasilan</th>";
                                        ...
                                        //thead += "<th>Rata-rata Penghasilan</th>";
                                        //trAyah += "<td>" + formatter.format(rataRataPenghasilanAyah) + "</td>";
                                    ...
                                    <script>
                                        ...
                                        dataSiswa.forEach(function(siswa) {
                                            ...
                                            //     console.log('Penghasilan Ayah:', penghasilanAyah);
                                            // console.log('Penghasilan Ibu:', penghasilanIbu);
                                            // console.log('Penghasilan Wali:', penghasilanWali);
                                            ...
                                            //   siswaPerKategoriAyah[penghasilanAyah].push(namaSiswa);
                                            //   siswaPerKategoriIbu[penghasilanIbu].push(namaSiswa);
                                            //   siswaPerKategoriWali[penghasilanWali].push(namaSiswa);
                                        });
            ...
            @elseif ($laporanType === 'jumlah_siswa')
                <div class="data-siswa py-3">
                    @php
                        $data_js = isset($data_js) ? $data_js : [];
                    @endphp
                    <!DOCTYPE html>
                    <html>
                    ...
                    <body>
                        ...
                        <script>
                            ...
                            var laporan = new Chart(ctx, {
                                type: 'line',
                                data: {
                                    labels: {!! json_encode($data_js[1]) !!},
                                    datasets: [{
                                            label: 'Data Jumlah Siswa',
                                            data: {!! json_encode(array_column($data_js[0], 'siswa')) !!},
                                            backgroundColor: 'rgba(255, 99, 132, 0.2)',
                                            borderColor: 'rgba(255, 99, 132, 1)',
                                            borderWidth: 1
                                        },
                                        {
                                            label: 'Data Jumlah Arship',
                                            data: {!! json_encode(array_column($data_js[0], 'arship')) !!},
                                            backgroundColor: 'rgba(54, 162, 235, 0.2)',
                                            borderColor: 'rgba(54, 162, 235, 1)',
                                            borderWidth: 1
                                        }
