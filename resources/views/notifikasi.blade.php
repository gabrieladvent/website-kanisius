            ...
            <div class=" table-data" style="margin-left: 1%; margin-right:1%;">
                <div class="card">
                    <div class="card-header" style="background: #89a5dd; display: flex; align-items: center;">
                        ...
                        <lord-icon src="https://cdn.lordicon.com/msetysan.json" trigger="hover" colors="primary:#121331"
                            style="width: 45px; height: 30px; margin-left: 10px;">
                        </lord-icon>
                    </div>

                    <div class="message-box"
                        style="background-color: white; box-shadow:4px 7px 10px rgba(0,0,0,.4);padding:1%">
