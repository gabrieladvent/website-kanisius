                ...
                @if (strpos($userKirim, 'TK') === 0)
                    ...
                    <div class="row d-flex justify-content-center mt-3 ms-5">
                        <div class="col-3 justify-content-center ms-5">
                            <form action="{{ route('update-data-TK', ['id' => $notifikasi->id_kirim]) }}" method="POST">
                                @csrf
                        ...
                        <div class="col-3 justify-content-center ms-5">
                            <a href="{{ route('update-and-download-TK', ['id' => $notifikasi->id_kirim]) }}" class="btn btn-white border border-2">Update-Download</a>
                        </div>
                    </div>
                @else
                    <table id="example" class="table table-bordered" style="width:100%">
