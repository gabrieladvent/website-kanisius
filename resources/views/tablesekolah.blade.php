...
<header>
    <!-- Sidebar -->
    <nav id="sidebarMenu" style="width: 100px !important;" class="collapse d-lg-block sidebar collapse bg-white">
    ...
    <nav id="main-navbar" class="navbar navbar-expand-lg navbar-light bg-white fixed-top">
      ...
      <div class="container-fluid">
        ...
        <a class="navbar-brand" href="#">
          <img src="img/logo-status.png" class="w-75"  alt="Kanisius Logo"
            loading="lazy" />
        </a>
...
<div class="col mt-5 py-5 px-5 container-fluid shadow-6-strong">
    <div class="mt-3 text-center ">
        <h3 class="fw-bold">Siswa - Siswi <span class="text-danger">SD Sanken</span> <br>
